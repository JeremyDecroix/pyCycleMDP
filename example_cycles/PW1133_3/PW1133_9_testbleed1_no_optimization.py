    ...
    def setup(self):
        ...
        if design:
            ...
            self.add_subsystem('fan_dia', om.ExecComp('FanDia = 2.0*(area/(pi*(1.0-hub_tip**2.0)))**0.5',
                            area={'value':4689, 'units':'inch**2'},
                            hub_tip={'value':0.3, 'units':None},
                            FanDia={'value':81, 'units':'inch'}))
            self.connect('inlet.Fl_O:stat:area', 'fan_dia.area')

            self.add_subsystem('opr_calc', om.ExecComp('OPR_simple = FPR*LPCPR*HPCPR',
                            FPR={'value':1.52, 'units':None},
                            LPCPR={'value':2.246, 'units':None},
                            HPCPR={'value':13.5, 'units':None},
                            OPR_simple={'value':46.088, 'units':None}))
...
def viewer(prob, pt, file=sys.stdout):
    ...
    bleed_names = ['byp_bld','bld25','hpc','bld3']
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        self.set_input_defaults('TOC.duct2.dPqP', 0.0048),
        self.set_input_defaults('TOC.balance.rhs:lpc_eff', 0.9150),
        self.set_input_defaults('TOC.duct25.dPqP', 0.0101),
        self.set_input_defaults('TOC.balance.rhs:hpt_eff', 0.8734),
        self.set_input_defaults('TOC.duct45.dPqP', 0.0051),
        self.set_input_defaults('TOC.balance.rhs:lpt_eff', 0.8854),
        self.set_input_defaults('TOC.duct5.dPqP', 0.0107),
        self.set_input_defaults('TOC.duct17.dPqP', 0.0136),
        ...
        self.set_input_defaults('TOC.duct2.MN', 0.4),
        self.set_input_defaults('TOC.lpc.MN', 0.4),
        self.set_input_defaults('TOC.bld25.MN', 0.4),
        self.set_input_defaults('TOC.duct25.MN', 0.4),
        ...
        self.set_input_defaults('TOC.duct45.MN', 0.3),
        ...
        self.pyc_add_cycle_param('hpc.bld_exit:frac_P', 0.55),
        ...
        self.add_subsystem('T4_ratio',
                             om.ExecComp('TOC_T4 = RTO_T4*TR',
                                         RTO_T4={'value': 3380.0, 'units':'degR'},
                                         TOC_T4={'value': 2994.5, 'units':'degR'},
                                         TR={'value': 0.885946, 'units': None}), promotes_inputs=['RTO_T4',])
        #Removed Line
