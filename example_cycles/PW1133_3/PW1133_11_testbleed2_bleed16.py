...
class N3(pyc.Cycle):
    ...
    def setup(self):
        ...
        #with bleed 16
        """main_order = ['fc', 'inlet', 'fan', 'splitter', 'duct4', 'lpc', 'duct6', 'hpc', 'bld3', 'burner', 'hpt', 'duct11',
                            'lpt', 'duct13', 'core_nozz', 'byp_bld', 'duct15', 'bld16', 'byp_nozz', 'gearbox', 'fan_shaft', 'lp_shaft', 'hp_shaft',
                            'perf', 'ext_ratio']"""
        
        #with bleed 16 + ATDBleed
        """main_order = ['fc', 'inlet', 'fan', 'splitter', 'duct4', 'lpc', 'duct6', 'hpc', 'bld3', 'burner', 'hpt', 'ATD_Bleed','duct11',
                            'lpt', 'duct13', 'core_nozz', 'byp_bld', 'duct15', 'bld16', 'byp_nozz', 'gearbox', 'fan_shaft', 'lp_shaft', 'hp_shaft',
                            'perf', 'ext_ratio']"""
        ...
        #self.pyc_connect_flow('hpt.Fl_O', 'ATD_Bleed.Fl_I')
        #self.pyc_connect_flow('ATD_Bleed.Fl_O', 'duct11.Fl_I')
        ...
        #self.pyc_connect_flow('duct15.Fl_O', 'bld16.Fl_I')
        #self.pyc_connect_flow('bld16.Fl_O', 'byp_nozz.Fl_I')
        ...
        #self.pyc_connect_flow('bld3.ATDbleed', 'ATD_Bleed.ATDbleed', connect_stat=False)
...
class MPN3(pyc.MPCycle):
    ...
    def setup(self):
        ...
        #self.pyc_add_cycle_param('bld16.bld_16:frac_W', 0.0),
