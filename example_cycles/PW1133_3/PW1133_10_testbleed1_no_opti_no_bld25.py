...
class N3(pyc.Cycle):
    ...
    def setup(self):
        ...
        main_order = ['fc', 'inlet', 'fan', 'splitter', 'duct2', 'lpc', 'duct25', 'hpc', 'bld3', 'burner', 'hpt', 'duct45',
        ...
        self.pyc_connect_flow('lpc.Fl_O', 'duct25.Fl_I')
...
def viewer(prob, pt, file=sys.stdout):
    ...
    fs_names = ['fc.Fl_O','inlet.Fl_O','fan.Fl_O','splitter.Fl_O1','duct2.Fl_O',
                'lpc.Fl_O','duct25.Fl_O','hpc.Fl_O','bld3.Fl_O',
