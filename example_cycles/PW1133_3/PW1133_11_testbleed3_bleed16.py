...
class N3(pyc.Cycle):
    ...
    def setup(self):
        ...
        if cooling:
            ...
            balance.add_balance('hpt_nochrg_cool_frac', val=0.037, lower=0.02, upper=.15, eq_units='lbm/s')
            ...
            balance.add_balance('hpt_chrg_cool_frac', val=0.061, lower=0.02, upper=.15, eq_units='lbm/s')
